...
class VideoServiceBase {
  ...
  getEmbedCode(videoID) {
    ...
    return `<div class="video-container ${containerClassNames.join(" ")}">
					<img src="https://i.ytimg.com/vi/${videoID}/hqdefault.jpg" alt="">
					<!-- add iframe, video etc right here on click -->
					<a tabindex="0" href="${videoUrl}" role="button" aria-label="Play video" class="play"></a>
				</div>\n`;
